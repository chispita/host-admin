<?php
   ...
   */
	...
	public static function decir($txt = "", $rtns = 1)
	{
	...
	# Escribe algo en la pantalla y deja el cursor al principio:
	public static function DiAtras($texto)
	{
		passthru('echo -en "\e[1D\e[s'.str_repeat(" ", 100).'\e[u\e[s'.Console_Color::Convert($texto).'\e[u"');
	}
	
	# Borra la línea actual del cursor, pero lo deja al principio de la misma:
	public static function BorraLinea()
	{
		passthru('echo -en "\e[1K\e[u"');
	}
    }
?> 