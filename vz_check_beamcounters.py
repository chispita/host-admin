...
def send_mail(count_change):
        ...
        p.write("From: root\n")
        p.write("To: sistemas@desarrollo.ibercivis.es\n")
        p.write("Subject: Han aumentado los beamcounters\n")
        p.write("\n") # blank line separating headers from body
        p.write("Los valores de Beancounter-failcnt los siguientes VEs y recursos se han \n")
        p.write("incrementado desde la última comprobación:\n\n")
